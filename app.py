...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
                ...
                dcc.RadioItems(options=YesNoOpt, value='No',  id='AlcoholDrinking'),
                html.Br(),
                html.Div('Stroke:'),
                ...
                html.Br(),
                html.Div('Sex:'),
                dcc.RadioItems(options=SexOpt, value='Male',  id='Sex'),
                html.Br(),
                ...
                html.Br(),
                html.Div('Diabetic:'),
                dcc.RadioItems(options=YesNoOpt, value='No',  id='Diabetic'),
                html.Br(),
                html.Div('PhysicalActivity:'),
                dcc.RadioItems(options=YesNoOpt, value='No',  id='PhysicalActivity'),
                html.Br(),
                html.Div('GenHealth:'),
                dcc.Dropdown(options=GenHealthOpt, value='Good', id='GenHealth'),
                html.Br(),
                html.Div('SleepTime:'),
                dcc.Slider(0, 24, .5,value=8,id='SleepTime'), ##={"placement": "top", "always_visible": True}), ##{0: '0 hrs',2: '2 hrs',4: '4 hrs',6: '6 hrs',8: '8 hrs',10: '10 hrs',12: '12 hrs',14: '14 hrs',16: '16 hrs',18: '18 hrs',20: '20 hrs'}),
                html.Br(),
                html.Div('Asthma:'),
                dcc.RadioItems(options=YesNoOpt, value='No',  id='Asthma'),
                html.Br(),
                html.Div('KidneyDisease:'),
                dcc.RadioItems(options=YesNoOpt, value='No',  id='KidneyDisease'),
                html.Br(),
                html.Div('SkinCancer:'),
                dcc.RadioItems(options=YesNoOpt, value='No',  id='SkinCancer'),
